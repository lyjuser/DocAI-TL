...
#             self.annotation_name_list.append(file)
#
#     def __len__(self):
#         return len(self.dataset_1)
#
...
#         img, img_path = self.dataset_1[idx]
#         mask, mask_path = self.dataset_2[idx]
#         annotation_path = self.annotation_name_list[idx]
#         return img, img_path, mask, mask_path, annotation_path
#         # return self.dataset_1[idx], self.dataset_2[idx]
...
class ImageLoader(Dataset):
    ...
    def __getitem__(self, img_patch_path):
        # img_patch_name = img_patch_path.split('\\')[-1] # 本地
        img_patch_name = img_patch_path.split('/')[-1] # 服务器
...
class PairedImageFolders(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #        img, img_path, img_annotation_path
        return img_patch, img_patch_path, mask_patch, mask_patch_path, patch_annotation_path, \
